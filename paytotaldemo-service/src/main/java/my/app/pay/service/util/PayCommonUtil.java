...
public class PayCommonUtil {
    ...
    static {
         apiKey = PropertiesIoUtils.returnPropertiesList().getApiKey();
     }
        ...
        StringBuilder sb = new StringBuilder();
          ...
          while(it.hasNext()) {  
              ...
              if ("attach".equalsIgnoreCase(key)||"body".equalsIgnoreCase(key)||"sign".equalsIgnoreCase(key)) {  
                  sb.append("<").append(">").append("<![CDATA[").append(value).append("]]></").append(key).append(">");
              }else {  
                  sb.append("<").append(">").append(value).append("</").append(">");
              }
          }  
          sb.append("</xml>");  
          return sb.toString();  
