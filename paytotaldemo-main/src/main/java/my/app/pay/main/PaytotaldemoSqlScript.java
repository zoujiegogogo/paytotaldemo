...
public class PaytotaldemoSqlScript {

    public static void main(String[] args) throws Exception {
        new PaytotaldemoSqlScript().run(args);
    }
    ...
    private void run(String[] args) throws Exception {
        ...
        // runSql(jdbcUrl, "drop database if exists paytotaldemo");
        runSql(jdbcUrl, "create database if not exists paytotaldemo");
    ...
    private String getSqlFile(String dir, String name) {
        try {
            ...
            if (dir != null) {
                ...
                URL url = PaytotaldemoSqlScript.class.getClassLoader().getResource(name);
    ...
    private void runScript(String scriptFile) throws Exception {
        String jdbcUrl = "jdbc:lealone:tcp://localhost/paytotaldemo?user=root&password=";
    ...
    private void runSql(String url, String sql, String srcDir) throws Exception {
        try (Connection conn = DriverManager.getConnection(url); Statement stmt = conn.createStatement()) {
            if (srcDir != null) {
                String setSql = "set @srcDir '" + srcDir + "'";
